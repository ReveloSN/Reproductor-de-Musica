...
function createRendererElements(documentRef: Document): RendererElements {
  return {
    ...
    youtubeApiKeyInput: requireElement<HTMLInputElement>(documentRef, 'youtubeApiKeyInput'),
    youtubeSaveKeyButton: requireElement<HTMLButtonElement>(documentRef, 'youtubeSaveKeyButton'),
    youtubeClearKeyButton: requireElement<HTMLButtonElement>(documentRef, 'youtubeClearKeyButton'),
    youtubeKeyStatus: requireElement<HTMLParagraphElement>(documentRef, 'youtubeKeyStatus'),
